      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-36 pb-24">
        <div className="flex flex-col items-center text-center mb-16">
          ...
          <div className="mt-10 glass-panel p-8 md:p-10 rounded-lg max-w-3xl mx-auto shadow-lg border-2 border-primary/20">
            <p className="text-xl md:text-2xl text-foreground/90">Why should Ayra exist? Why should anyone care to use it? Why is privacy so important to us?</p>
        ...
        <WhySection id="why-1" icon={<Lightbulb className="w-6 h-6 text-primary" />} title="Because why not do something different?" content={<>
              <p>
              ...
              <p>With Ayra we ultimately asked ourselves, why not? Why not find a different way to save what we care about? Why not remove all the other stuff that just gets in the way? Forget how it's usually done. Why not make it better?</p>
              <div className="mt-6">
              ...
              <div className="mt-4 text-sm text-muted-foreground">
                <p className="font-medium">The beginning — How did we end up creating Ayra?</p>
                <p className="mt-2 font-medium">A letter — How can we build an extension of your mind?﻿</p>
              </div>
            </>} />
        
        <WhySection id="why-2" icon={<Heart className="w-6 h-6 text-primary" />} title="Because we need better relationships with technology." content={<>
              <p>
              ...
              <div className="mt-4 text-sm text-muted-foreground">
                ...
                <p className="mt-2 font-medium">A thought from Ayra on social features﻿</p>
                <p className="mt-2 font-medium">A tool that works with your brain, not against it</p>
              </div>
            </>} />
        
        <WhySection id="why-3" icon={<RefreshCw className="w-6 h-6 text-primary" />} title="Because new beginnings are beautiful." content={<>
              <p>
        ...
        <WhySection id="why-4" icon={<Zap className="w-6 h-6 text-primary" />} title="Because a tool is just the means to an end, not the end in itself." content={<>
              <p>We built Ayra for doers and makers. For people who are busy doing other things and simply need a place to collect and remember what they care about.</p>
              <p>Ayra doesn't interfere, doesn't bother and doesn't ask to be maintained. It's meant to serve you, as an extension of your mind. So you can think about anything and everything except the tool itself.</p>
              <p>Because that's all it is: A tool meant to help you achieve something else. Those who like to procrastinate with folders and unmaintainable systems will find plenty of other apps to keep them busy. Ayra is for those who would rather draw and write and build and dance and sing.</p>
            </>} />
